...
**PHASE 03:** Once the process status is "Completed," you can move on to Phase 03, when you will call the [**GET/api/v2/processo/{idProcesso}**](available-methods-in-the-api/1.1.get-api-v2-processo-idprocesso.md) method to retrieve the complete process data and the signed file.
