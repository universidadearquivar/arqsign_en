...
The API returns the ID of the process recipient.

**b. ordem**

The API returns the signing order of the recipient.

**c. formaEnvioProcesso**

The API returns the method used to send the process to the recipient, such as email or phone.

**d. nome**

The API returns the name of the recipient.

**e. anexo**

The API returns the recipient's attachment configurations, if any.
