...
The user can purchase extra credits for sending documents via email, as well as credits for sending security codes via SMS.

{% hint style="warning" %}
<mark style="color:orange;">**Extra credits have a validity period of six months for consumption.**</mark>
{% endhint %}

When clicking on "Buy Credits," the user will be directed to the checkout screen. They should specify the quantity of credits they want to purchase for each type (email and SMS) and click "Proceed."

{% hint style="warning" %}
<mark style="color:orange;">**If the user's account has unlimited email sending, it will only be possible to purchase extra credits for sending security codes via SMS.**</mark>
{% endhint %}
