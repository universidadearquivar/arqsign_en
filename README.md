...
<figure><img src=".gitbook/assets/image (3) (1) (1) (1).png" alt=""><figcaption><p>Click on the image to nlarge.</p></figcaption></figure>
...
The free trial account of the ArqSign Platform offers users nearly all the functionalities and features of the paid account, including sending documents for signature with or without a digital certificate, creating dedicated folders for document management, importing digital certificates, and integration with other systems. The user can send documents for signature free of charge.

{% hint style="warning" %}
<mark style="color:orange;">In the free trial account, it is not allowed to add other users, meaning only the owner can access and manage the documents sent and received for signature.</mark>

&#x20;<mark style="color:orange;">The creation of a free trial account is permitted for any user who does not have an email registered for other free trials on the ArqSign platform</mark>
{% endhint %}
...
<figure><img src=".gitbook/assets/image (2).png" alt=""><figcaption><p>Click on the image to enlarge.</p></figcaption></figure>
...
{% hint style="warning" %}
<mark style="color:orange;">At the end of the trial period , the user can continue accessing the platform normally. However, to make new submissions, they must purchase a paid plan (for sending new documents via email).</mark>
{% endhint %}
...
<figure><img src=".gitbook/assets/13 (2).png" alt=""><figcaption><p>Click on the image to enlarge.</p></figcaption></figure>
